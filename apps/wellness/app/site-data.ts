...
export const productPicks: ProductPick[] = [
  {
    ...
    specs: [
      ...
      { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" },
    ],
    imageUrl: "https://avidlove.com/cdn/shop/files/AML010033_PAT2-2.jpg?v=1743596749&width=1200",
    price: "See current price at retailer",
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Format", value: "Modal cami and shorts" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Format", value: "Cami PJ set" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Format", value: "One-piece slip" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Format", value: "Full-slip sleep dress" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Format", value: "Satin mini chemise" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Layer", value: "Short satin robe" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Layer", value: "Sheer kimono robe" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Layer", value: "Lace kimono robe" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
  ...
  },
  {
    ...
    specs: [{ label: "Retailer", value: "Avidlove via CJ" }, { label: "Shape", value: "High neck, racerback" }, { label: "Price and availability", value: "Vary by size and color; confirm at the retailer" }],
