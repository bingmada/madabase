...
export const toolRegistry: ToolRegistryEntry[] = [
  ...
  { slug: "json-diff", component: "JsonDiff", category: "developer", relatedTools: ["json-formatter", "json-validator", "json-escape"], keywords: ["json diff", "compare json online"], h1: { en: "Free JSON Diff Online", zh: "免费 JSON Diff 工具" }, description: { en: "Compare two JSON documents and inspect differences.", zh: "比较两个 JSON 文档并查看差异。" } },
  { slug: "json-escape", component: "JsonEscape", category: "developer", relatedTools: ["json-formatter", "json-validator", "base64"], keywords: ["json escape", "escape json string"], h1: { en: "Free JSON Escape Tool", zh: "免费 JSON Escape 工具" }, description: { en: "Escape JSON strings for code, logs, and payloads.", zh: "转义 JSON 字符串，适用于代码、日志和请求体。" } },
  ...
  { slug: "regex-tester", component: "RegexTester", category: "developer", popular: true, relatedTools: ["word-counter", "text-cleaner", "slug-generator"], keywords: ["regex tester", "regular expression tester"], h1: { en: "Free Regex Tester Online", zh: "免费 Regex Tester 工具" }, description: { en: "Test regular expressions against sample text.", zh: "对示例文本测试正则表达式。" } },
  { slug: "cron-generator", component: "CronGenerator", category: "developer", relatedTools: ["timestamp", "regex-tester", "uuid-generator"], keywords: ["cron generator", "cron expression generator"], h1: { en: "Free Cron Generator Online", zh: "免费 Cron Generator 工具" }, description: { en: "Generate cron expressions for scheduled jobs.", zh: "生成定时任务 cron 表达式。" } },
  { slug: "hash-generator", component: "HashGenerator", category: "developer", relatedTools: ["password-generator", "uuid-generator", "base64"], keywords: ["hash generator", "text hash generator"], h1: { en: "Free Hash Generator Online", zh: "免费 Hash Generator 工具" }, description: { en: "Generate a simple hash from plain text.", zh: "从文本生成简单哈希值。" } },
  { slug: "color-converter", component: "ColorConverter", category: "web", relatedTools: ["css-formatter", "html-formatter", "qr-code-generator"], keywords: ["color converter", "hex to rgb"], h1: { en: "Free Color Converter Online", zh: "免费 Color Converter 工具" }, description: { en: "Convert color values like HEX to RGB.", zh: "转换颜色值，例如 HEX 转 RGB。" } },
  { slug: "password-generator", component: "PasswordGenerator", category: "developer", popular: true, relatedTools: ["uuid-generator", "hash-generator", "base64"], keywords: ["password generator", "random password generator"], h1: { en: "Free Password Generator Online", zh: "免费 Password Generator 工具" }, description: { en: "Generate strong passwords instantly.", zh: "立即生成强密码。" } },
  { slug: "word-counter", component: "WordCounter", category: "text", relatedTools: ["character-counter", "text-cleaner", "markdown-preview"], keywords: ["word counter", "count words online"], h1: { en: "Free Word Counter Online", zh: "免费 Word Counter 工具" }, description: { en: "Count words in plain text instantly.", zh: "快速统计文本中的单词数量。" } },
  { slug: "character-counter", component: "CharacterCounter", category: "text", relatedTools: ["word-counter", "text-cleaner", "slug-generator"], keywords: ["character counter", "count characters online"], h1: { en: "Free Character Counter Online", zh: "免费 Character Counter 工具" }, description: { en: "Count characters in text instantly.", zh: "快速统计文本字符数。" } },
  { slug: "case-converter", component: "CaseConverter", category: "text", relatedTools: ["text-cleaner", "slug-generator", "word-counter"], keywords: ["case converter", "uppercase lowercase converter"], h1: { en: "Free Case Converter Online", zh: "免费 Case Converter 工具" }, description: { en: "Convert text to upper, lower, and title case.", zh: "转换为大写、小写和标题格式。" } },
  { slug: "text-cleaner", component: "TextCleaner", category: "text", relatedTools: ["case-converter", "word-counter", "character-counter"], keywords: ["text cleaner", "remove extra spaces"], h1: { en: "Free Text Cleaner Online", zh: "免费 Text Cleaner 工具" }, description: { en: "Clean text by removing extra spaces and line noise.", zh: "清理文本中的多余空格和杂乱换行。" } },
  { slug: "slug-generator", component: "SlugGenerator", category: "text", relatedTools: ["url-encoder", "case-converter", "word-counter"], keywords: ["slug generator", "url slug generator"], h1: { en: "Free Slug Generator Online", zh: "免费 Slug Generator 工具" }, description: { en: "Generate clean URL slugs from titles.", zh: "从标题生成干净的 URL slug。" } },
  { slug: "qr-code-generator", component: "QrCodeGenerator", category: "web", popular: true, relatedTools: ["url-parser", "url-encoder", "slug-generator"], keywords: ["qr code generator", "generate qr code online"], h1: { en: "Free QR Code Generator Online", zh: "免费 QR Code Generator 工具" }, description: { en: "Generate QR codes for links and text.", zh: "为链接和文本生成二维码。" } },
  { slug: "html-encoder", component: "HtmlEncoder", category: "web", relatedTools: ["html-formatter", "url-encoder", "base64"], keywords: ["html encoder", "escape html online"], h1: { en: "Free HTML Encoder Online", zh: "免费 HTML Encoder 工具" }, description: { en: "Encode HTML entities safely.", zh: "安全编码 HTML 实体。" } },
  { slug: "css-formatter", component: "CssFormatter", category: "web", relatedTools: ["html-formatter", "js-formatter", "color-converter"], keywords: ["css formatter", "css beautifier"], h1: { en: "Free CSS Formatter Online", zh: "免费 CSS Formatter 工具" }, description: { en: "Beautify CSS for easier editing and debugging.", zh: "格式化 CSS，便于编辑和调试。" } },
  { slug: "js-formatter", component: "JsFormatter", category: "developer", relatedTools: ["json-formatter", "css-formatter", "html-formatter"], keywords: ["javascript formatter", "js beautifier"], h1: { en: "Free JavaScript Formatter Online", zh: "免费 JavaScript Formatter 工具" }, description: { en: "Format JavaScript snippets for readability.", zh: "格式化 JavaScript 片段，提高可读性。" } },
  { slug: "url-parser", component: "UrlParser", category: "web", relatedTools: ["url-encoder", "slug-generator", "qr-code-generator"], keywords: ["url parser", "parse url online"], h1: { en: "Free URL Parser Online", zh: "免费 URL Parser 工具" }, description: { en: "Parse URLs into protocol, host, path, query, and hash.", zh: "解析 URL 的协议、域名、路径、查询参数和锚点。" } },
];
