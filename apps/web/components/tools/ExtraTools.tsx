...
function GenericTextTransformTool({
  ...
  function run() {
    try {
      ...
      setMessage("Done.");
      setTone("success");
      trackEvent({ event: "tool_use", tool });
    } catch (error) {
...
export function RegexTester() {
  ...
  function run() {
    try {
      ...
      setTone("success");
      trackEvent({ event: "tool_use", tool: "regex-tester" });
    } catch (error) {
    ...
    <ToolPanel>
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <ToolButton onClick={() => trackEvent({ event: "tool_use", tool: "cron-generator" })}>Generate</ToolButton>
        </div>
      </div>
    </ToolPanel>
  );
  ...
  return (
    <ToolPanel>
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          <CopyButton value={output} />
          <ToolButton onClick={() => trackEvent({ event: "tool_use", tool: "password-generator" })}>Generate</ToolButton>
        </div>
      </div>
    </ToolPanel>
  );
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_220px]">
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <ToolButton onClick={() => trackEvent({ event: "tool_use", tool: "qr-code-generator" })}>Generate QR</ToolButton>
          </div>
        </div>
