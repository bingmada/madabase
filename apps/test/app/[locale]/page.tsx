        ...
        <section className="mt-10">
          ...
          <div className="mt-5 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {tests.map(({ test, content }) => (
              <Link key={test.slug} href={`/${locale}/${test.slug}`} className="group surface-card p-5 transition hover:-translate-y-0.5 hover:border-[var(--brand)] hover:shadow-[var(--shadow-panel)]">
