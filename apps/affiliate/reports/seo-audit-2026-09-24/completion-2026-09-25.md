...
用户随后授权“发布吧”：三个服务已于 2026-09-25 发布，302/302 公网页面、32 个 Costume 购买页面和 76 个商品发现入口通过；90 个实质修改 URL 获 IndexNow 接收。完整发布证据、回滚过程及剩余外部项见 [正式发布记录](../seo-release-2026-09-25/README.md)。之后发现的 Wellness 525 已在用户授权的 Cloudflare 复核中确认恢复：San Jose、新加坡和应用源站响应正常，未改配置；根因仍未确认，保留观察项。以下保留本轮内容修改和发布前验证明细。
