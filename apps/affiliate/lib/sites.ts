...
export const sites: Record<SiteKey, SiteConfig> = {
  ...
  costume: {
    key: "costume",
    name: "Madabase Halloween & Costume Guide",
    tagline: "Plan the Halloween look, scare, and setup before October 31.",
    ...
    categories: [
      { slug: "costumes", name: "Halloween Costumes", description: "Adult, kids, creature, gothic, licensed, theatrical, cosplay, and inflatable looks compared by exact fit, included pieces, movement, and timing." },
      { slug: "props-animatronics", name: "Haunted Props", description: "Carry props, display pieces, large effects, and animatronics compared by dimensions, power, weather limits, guest clearance, and storage." },
      { slug: "masks-prosthetics", name: "Masks & Prosthetics", description: "Halloween masks and prosthetics compared by head fit, visibility, breathing, materials, application, removal, and realistic wear time." },
      { slug: "wigs-makeup", name: "Wigs & SFX Makeup", description: "Wigs, facial hair, fake blood, makeup, and special effects planned as a compatible application, touch-up, removal, and care system." },
      { slug: "accessories-party-effects", name: "Decor & Party Effects", description: "Pumpkins, ghosts, accessories, decor, lighting, fog, and atmosphere pieces chosen for the measured room or yard, event timing, power, cleanup, and storage." },
    ],
  },
};
