...
export const products: Product[] = [
  ...
  },
  {
    ...
    asin: "B0B9ZVST99",
    amazonTitle: "Nanit Pro Smart Baby Monitor and Flex Stand",
    updatedAt: "July 16, 2026",
    ...
    specs: { ASIN: "B0B9ZVST99", "Product type": "Smart baby monitor with Flex Stand", "Use case": "App-based monitoring", "Link status": "Amazon affiliate link verified July 16, 2026" },
    evidence: ["Confirm ASIN B0B9ZVST99 and check which Nanit insights require a subscription", "Verify that the Flex Stand bundle fits the intended nursery placement", "Compare Wi-Fi privacy comfort against local monitors"],
    ...
    offers: [{ merchant: "Amazon US", url: "https://www.amazon.com/dp/B0B9ZVST99?tag=bingmada-20&linkCode=ll2&language=en_US&ref_=as_li_ss_tl", label: "Check price on Amazon", priceNote: "Confirm ASIN B0B9ZVST99, Flex Stand bundle, seller, live price, and availability." }],
  },
  {
    site: "baby",
