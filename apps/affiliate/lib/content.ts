...
export const products: Product[] = [
  ...
  },
  {
    ...
    specs: { ASIN: "B097QZGRCQ", "Light type": "Compact video light", "Use case": "Meetings", "Link status": "Amazon affiliate link verified July 16, 2026" },
    evidence: ["Confirm ASIN B097QZGRCQ, the current Logitech Litra Glow mount, and power connection on Amazon", "Compare with desk lamps and larger key lights", "Check whether it fits your monitor or laptop placement"],
  ...
  },
  {
    ...
    specs: { ASIN: "B0C3DHK1LL", "Product type": "Sterilizer dryer", "Use case": "Bottle and pump-part routine", "Link status": "Amazon affiliate link verified July 16, 2026" },
    evidence: ["Confirm ASIN B0C3DHK1LL and compare Baby Brezza cycle options, drying modes, and capacity", "Check counter footprint and where clean parts will land after a cycle", "Verify part compatibility for your bottle and pump system"],
    ...
    offers: [{ merchant: "Amazon US", url: "https://www.amazon.com/dp/B0C3DHK1LL?tag=bingmada-20&linkCode=ll2&language=en_US&ref_=as_li_ss_tl", label: "Check price on Amazon", priceNote: "Confirm ASIN B0C3DHK1LL, color, seller, live price, and availability." }],
  },
  {
    site: "baby",
...
export const roundups: Roundup[] = [
  ...
  },
  {
    ...
    methodology: ["Compare one full day of bottles and pump parts against real capacity", "Separate washing, sterilizing, drying, and storage functions", "Measure counter footprint, lid clearance, and cleanup access before buying"],
    productSlugs: [
