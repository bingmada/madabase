...
export const products: Product[] = [
  {
    ...
    brand: "PETLIBRO",
    category: "feeding",
    image: "/images/affiliate/pet-petlibro-granary-automatic-cat-feeder.jpg",
    ...
    specs: { "Product type": "Automatic feeder", "Use case": "Scheduled meals", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Check hopper size against feeding schedule", "Verify kibble-size compatibility", "Compare power backup and cleaning access"],
  ...
  },
  {
    ...
    brand: "Catit",
    category: "feeding",
    image: "/images/affiliate/pet-catit-flower-cat-water-fountain.jpg",
    ...
    specs: { "Product type": "Water fountain", "Use case": "Daily hydration", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Check replacement filter availability", "Compare reservoir size against number of cats", "Verify cleaning steps before buying"],
  ...
  },
  {
    ...
    brand: "Furbo",
    category: "home-care",
    image: "/images/affiliate/pet-furbo-360-dog-camera.jpg",
    ...
    specs: { "Product type": "Pet camera", "Use case": "Interactive monitoring", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Compare subscription requirements", "Check treat-size compatibility", "Verify camera placement and privacy comfort"],
  ...
  },
  {
    ...
    brand: "Wyze",
    category: "home-care",
    image: "/images/affiliate/pet-wyze-cam-pan-v3-pet-camera.jpg",
    ...
    specs: { "Product type": "Indoor camera", "Use case": "Simple pet monitoring", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Compare privacy and storage settings", "Check placement where the pet actually rests", "Verify whether subscription features are needed"],
  ...
  },
  {
    ...
    brand: "Litter Genie",
    category: "home-care",
    image: "/images/affiliate/pet-litter-genie-plus-pail.jpg",
    ...
    specs: { "Product type": "Litter disposal pail", "Use case": "Odor containment", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Check refill availability and cost", "Compare footprint against litter-box area", "Use with regular scooping rather than as a cleaning shortcut"],
  ...
  },
  {
    ...
    brand: "PetFusion",
    category: "comfort",
    image: "/images/affiliate/pet-petfusion-ultimate-dog-bed.jpg",
    ...
    specs: { "Product type": "Dog bed", "Use case": "Daily comfort", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Match bed size to sleeping position", "Check cover-removal and washing instructions", "Compare foam support against pet weight"],
  ...
  },
  {
    ...
    brand: "ChomChom",
    category: "home-care",
    image: "/images/affiliate/pet-chomchom-roller-pet-hair-remover.jpg",
    ...
    specs: { "Product type": "Pet hair remover", "Use case": "Furniture cleanup", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Compare surface type before recommending", "Use as a furniture tool rather than a vacuum replacement", "Check cleaning chamber size"],
  ...
  {
    site: "pet",
    slug: "levoit-core-300s-air-purifier",
    name: "LEVOIT Core 300S Air Purifier",
    brand: "LEVOIT",
    category: "home-care",
    image: "/images/affiliate/pet-levoit-core-300s-air-purifier.jpg",
    summary: "A compact air purifier option for pet homes that need help with dander, dust, and room freshness.",
    verdict: "The Core 300S is a sensible pet-home air purifier candidate when the room is modest, filter costs are acceptable, and the goal is daily air cleanup rather than miracle odor removal.",
    whyItMatters: "Air purifiers work best when room size, filter replacement, noise, and placement are realistic. They should support cleaning routines, not replace them.",
    bestFor: "Bedrooms and small living rooms with pets",
    priceBand: "$$",
    rating: 4.4,
    scores: [
      { label: "Room fit", value: 8 },
      { label: "Noise control", value: 8 },
      { label: "Filter upkeep", value: 7 },
    ],
    pros: ["Compact enough for bedrooms", "Useful for dander and dust support", "Recognizable filter ecosystem"],
    cons: ["Replacement filters add ongoing cost", "Odor control depends on source cleanup too"],
    specs: { "Product type": "Air purifier", "Use case": "Pet dander and dust", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Match CADR and room size", "Check filter replacement cost", "Place near pet zones without blocking airflow"],
    alternatives: ["Choose a larger purifier for open living spaces.", "Prioritize litter and fabric cleaning if odor is the main issue."],
  ...
  },
  {
    ...
    brand: "RisePro",
    category: "desks",
    image: "/images/affiliate/homeoffice-risepro-compact-standing-desk.jpg",
  ...
  },
  {
    ...
    brand: "AlignMesh",
    category: "ergonomics",
    image: "/images/affiliate/homeoffice-alignmesh-ergonomic-chair.jpg",
  ...
  },
  {
    ...
    brand: "BeamKey",
    category: "meetings",
    image: "/images/affiliate/homeoffice-beamkey-video-desk-lamp.jpg",
  ...
  },
  {
    ...
    brand: "FlexiSpot",
    category: "desks",
    image: "/images/affiliate/homeoffice-flexispot-e7-mini-standing-desk.jpg",
  ...
  },
  {
    ...
    brand: "UPLIFT Desk",
    category: "desks",
    image: "/images/affiliate/homeoffice-uplift-v3-standing-desk.jpg",
  ...
  },
  {
    ...
    brand: "Branch",
    category: "ergonomics",
    image: "/images/affiliate/homeoffice-branch-ergonomic-chair.jpg",
  ...
  },
  {
    ...
    brand: "HON",
    category: "ergonomics",
    image: "/images/affiliate/homeoffice-hon-ignition-2-0-chair.jpg",
  ...
  },
  {
    ...
    brand: "Ergotron",
    category: "ergonomics",
    image: "/images/affiliate/homeoffice-ergotron-lx-monitor-arm.jpg",
  ...
  },
  {
    ...
    brand: "Amazon Basics",
    category: "ergonomics",
    image: "/images/affiliate/homeoffice-amazon-basics-monitor-arm.jpg",
  ...
  },
  {
    ...
    brand: "Logitech",
    category: "meetings",
    image: "/images/affiliate/homeoffice-logitech-litra-glow.jpg",
  ...
  },
  {
    ...
    brand: "BenQ",
    category: "meetings",
    image: "/images/affiliate/homeoffice-benq-screenbar-halo.jpg",
  ...
  },
  {
    ...
    brand: "Anker",
    category: "desks",
    image: "/images/affiliate/homeoffice-anker-675-usb-c-docking-station.jpg",
  ...
  },
  {
    ...
    brand: "Infant Optics",
    category: "sleep",
    image: "/images/affiliate/baby-infant-optics-dxr-8-pro.jpg",
    ...
    specs: { "Product type": "Baby monitor", "Use case": "Local overnight monitoring", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Compare local monitor versus Wi-Fi preference", "Check room layout and range needs", "Review lens and parent-unit features before buying"],
  ...
  },
  {
    ...
    brand: "Nanit",
    category: "sleep",
    image: "/images/affiliate/baby-nanit-pro-smart-baby-monitor.jpg",
    ...
    specs: { "Product type": "Smart baby monitor", "Use case": "App-based monitoring", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Check subscription requirements", "Verify mounting option for the nursery", "Compare privacy comfort against local monitors"],
  ...
  },
  {
    ...
    brand: "Baby Jogger",
    category: "travel",
    image: "/images/affiliate/baby-summer-3dlite-convenience-stroller.jpg",
    ...
    specs: { "Product type": "Travel stroller", "Use case": "Errands and travel", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Compare folded dimensions against storage needs", "Check age and weight limits", "Review recline and basket access before buying"],
  ...
  },
  {
    ...
    specs: { "Product type": "Lightweight stroller", "Use case": "Budget travel", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Check current model and weight limit", "Compare folded size to car trunk space", "Use as a value pick rather than an all-terrain stroller"],
  ...
  },
  {
    ...
    brand: "Philips Avent",
    category: "feeding",
    image: "/images/affiliate/baby-philips-avent-bottle-sterilizer.jpg",
    ...
    specs: { "Product type": "Bottle sterilizer", "Use case": "Bottle routine", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Check exact model capacity", "Compare drying expectations", "Verify bottle and pump-part compatibility"],
  ...
  },
  {
    ...
    brand: "Baby Brezza",
    category: "feeding",
    image: "/images/affiliate/baby-baby-brezza-sterilizer-dryer-advanced.jpg",
    ...
    specs: { "Product type": "Sterilizer dryer", "Use case": "Bottle and pump-part routine", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Compare cycle options and capacity", "Check counter footprint", "Verify part compatibility for your bottle system"],
  ...
  },
  {
    ...
    brand: "Ergobaby",
    category: "travel",
    image: "/images/affiliate/baby-ergobaby-omni-breeze-carrier.jpg",
    ...
    specs: { "Product type": "Baby carrier", "Use case": "Hands-free travel", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Check age and weight guidance", "Compare fit for both caregivers", "Review safe positioning instructions before use"],
  ...
  },
  {
    ...
    brand: "Hatch",
    category: "sleep",
    image: "/images/affiliate/baby-hatch-rest-sound-machine.jpg",
    ...
    specs: { "Product type": "Sound machine", "Use case": "Sleep routine", "Link status": "Needs Amazon affiliate link" },
    evidence: ["Compare controls and app needs", "Check room brightness preferences", "Use alongside safe sleep guidance"],
...
export const roundups: Roundup[] = [
  ...
  },
  {
    ...
    productSlugs: ["litter-genie-plus-pail", "levoit-core-300s-air-purifier", "chomchom-roller-pet-hair-remover"],
    faqs: [
