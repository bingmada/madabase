...
export const products: Product[] = [
  ...
  },
  {
    ...
    specs: { ASIN: "B0C3DHK1LL", "Product type": "Sterilizer and dryer", "Published capacity": "8 bottles or 2 full pump-part sets plus accessories", Functions: "Sterilize and dry, sterilize only, dry only, storage rack", "Published drying": "30 minutes", "Closed-lid storage": "Up to 48 hours", "Before buying": "Confirm color, seller, bundle, voltage, and current warranty" },
    evidence: ["Confirm ASIN B0C3DHK1LL, selected color, seller, and current bundle", "Count a real bottle and pump-part load against the modular bin layout", "Measure permanent counter footprint and lid clearance", "Follow the current HEPA-filter replacement and descaling instructions"],
