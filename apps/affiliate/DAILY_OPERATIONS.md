...
| 2026-09-14 | Indexed-zero 40 正式 Day 7 已完成：6 页获得 12 展现且全部前十，34 个当前零展现页 live inspection 全部 indexed，40/40 公网页面与 Sitemap 通过。保护 6 页，其余 34 页保持至 9 月 21 日；ErGear 第二次 snippet 不重复改动或重提 | 9 月 21 日前再次批量重写这 34 页；把零展现误判为掉索引；重提 40 URL；9 月 20 日前再次改 ErGear |
| 2026-09-15 | 9 月 8 日 27-family 合并 Day 7 已完成：27 个保留 hub 在 Google 双七日窗和 Bing 当前七日均零展现，但 27/27 live inspection 均为 indexed；27 hub、91 个基础路径与 91 个 en-gb 永久重定向、19/19 分类发现链全部通过。全组保持至 9 月 22 日。ErGear 第二 snippet 获得首个滚动 24 小时点击，实验关闭并转永久保护 | 因 Day-7 零展现撤销 91 个重定向；再次改 ErGear snippet 或重提 IndexNow；把已收录误判为技术掉索引；新增路由 |
| 2026-09-22 / 10-08 | 9 月 8 日 27-family 合并的 Day 14 / Day 30；对仍零展现的精确 hub 执行需求差异、意图错配或退役判断 | 重写新增曝光、点击、查询扩展或前 20 排名的 hub；无精确证据恢复旧路由 |
...
| 2026-09-21 / 10-07 | Indexed-zero 40 Day 14 / Day 30；只复核 9 月 14 日仍零展现的精确 34 页，期间新增曝光页自动转保护 | 重置 6 个 Day-7 前十页；在没有需求、意图错配或合并证据时机械改标题/正文；新增路由 |
